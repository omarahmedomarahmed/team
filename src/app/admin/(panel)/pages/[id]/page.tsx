...
import { getSectionFields, SECTION_LABELS } from "@/lib/admin/sectionFields";
...
const SECTION_TYPES = [
  "PORTRAIT_HERO", "HERO", "TIMELINE", "EXPERIENCE_INDEX", "LOGOS", "PORTFOLIO",
  "VIDEO", "CONTACT", "CTA", "STATS", "ABOUT", "PROCESS", "RICH_TEXT",
  "SERVICES", "TEAM", "TESTIMONIALS", "INDUSTRIES", "FAQ", "CUSTOM",
];
...
export default async function PageEditor({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="space-y-8 max-w-3xl">
      <div>
        <Link href="/admin/pages" className="text-sm text-muted hover:text-fg inline-flex items-center gap-1.5">
