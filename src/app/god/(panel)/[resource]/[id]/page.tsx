...
import { getResource } from "@/lib/god/resources";
import { ResourceForm } from "@/components/god/ResourceForm";
...
export default async function ResourceEdit({
  ...
  return (
    <div className="space-y-6">
      <div>
        <Link href={`/god/${key}`} className="text-sm text-muted hover:text-fg inline-flex items-center gap-1.5">
