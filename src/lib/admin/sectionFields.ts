...
export const SECTION_LABELS: Record<string, string> = {
  ...
  EXPERIENCE_INDEX: "Experience cards",
  STATS: "Stats",
  ABOUT: "About / text",
...
export const SECTION_FIELDS: Record<string, Field[]> = {
  ...
  PORTRAIT_HERO: [
    ...
    { name: "portrait", label: "Portrait photo", type: "image", full: true, aspect: 3 / 4, fit: "cover" },
    { name: "bgImage", label: "Background image (optional)", type: "image", full: true, aspect: 16 / 9, fit: "cover" },
    { name: "primaryCta", label: "Main button", type: "link", full: true },
    { name: "secondaryCta", label: "Secondary button", type: "link", full: true },
  ],
  TIMELINE: [
  ...
  PORTFOLIO: [
    ...HEADING,
    { name: "category", label: "Filter by category", type: "text", help: "Leave blank to show all. e.g. Platform · Presentation." },
    { name: "featured", label: "Only featured items", type: "boolean" },
    { name: "limit", label: "Max items to show", type: "number", help: "Leave blank to show all." },
  ],
  EXPERIENCE_INDEX: [
    ...HEADING,
    { name: "category", label: "Filter to one category", type: "text", help: "Leave blank for all. e.g. Entrepreneurship." },
    { name: "groupByCategory", label: "Group by category", type: "boolean", help: "Show experiences grouped under category headings." },
    { name: "limit", label: "Max items to show", type: "number", help: "Leave blank to show all." },
  ],
  TEAM: COLLECTION,
